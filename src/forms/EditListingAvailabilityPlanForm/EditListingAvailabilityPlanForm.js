                    ...
                    <div className={css.formRow}>
                      <div className={css.field}>
                        ...
                        >
                          ...
                          {filterStartHours(availableStartHours, values, dayOfWeek, index).map((s) => (
                      ...
                      <div className={css.field}>
                        <FieldSelect id={`${name}.endTime`} name={`${name}.endTime`} selectClassName={css.fieldSelect}>
                          <option disabled value="">
                            {endTimePlaceholder}
                          </option>
  ...
  return (
    <FinalForm
      ...
      render={(fieldRenderProps) => {
        ...
        const concatDayEntriesReducer = (entries, day) => (values[day] ? entries.concat(values[day]) : entries)
        ...
        return (
          <Form id={formId} className={classes} onSubmit={handleSubmit}>
            <h2 className={css.heading}>
              <FormattedMessage id="EditListingAvailabilityPlanForm.title" values={{ listingTitle }} />
            </h2>
...
const EditListingAvailabilityPlanForm = compose(injectIntl)(EditListingAvailabilityPlanFormComponent)
