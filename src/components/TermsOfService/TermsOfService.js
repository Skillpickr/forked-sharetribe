...
const TermsOfService = (props) => {
  ...
  return (
    <div className={classes}>
      <p className={css.lastUpdated}>Last updated: February 25, 2022</p>
      ...
      <ul>
        <li>
          <p>
            ...
            electronic device, named SkillPickr
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to SkillPickr ApS, Læssøesgade 19, sttv, 2200 København N.
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        If You wish to place an Order for Goods available on the Service, You may be asked to supply certain information
      ...
      <p>
        You represent and warrant that: (i) You have the legal right to use any credit or debit card(s) or other payment
      ...
      <p>
        ...
        them. You should also include all of the products instructions, documents and wrappings. Goods that are damaged
        or not in the same condition as You received them or which are worn simply beyond opening the original packaging
      ...
      <p>
        ...
        images, specifications, availability, and services. We reserve the right to change or update information and to
      ...
      <p>
        ...
        submit Your notice in writing to the attention of our copyright agent via email at hello@SkillPickr.com and
      ...
      <p>
        You can contact our copyright agent via email at hello@SkillPickr.com. Upon receipt of a notification, the
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            <a
              href="http://dev.SkillPickr.com/about#contact"
              rel="external nofollow noopener noreferrer"
              target="_blank">
              http://dev.SkillPickr.com/about#contact
            </a>
          </p>
        </li>
      </ul>
