...
const PayoutDetailsIndividualAccountComponent = (props) => {
  ...
  const individualConfig =
    country && stripeCountryConfigs(country).individualConfig ? stripeCountryConfigs(country).individualConfig : {}
  ...
  const hasBusinessURL =
    values && values.individual && values.individual.businessProfile && values.individual.businessProfile.url
