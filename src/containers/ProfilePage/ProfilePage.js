    ...
    const asideContent = (
      <div className={css.asideContent}>
        ...
        <h1 className={css.mobileHeading}>
          {displayName ? <FormattedMessage id="ProfilePage.mobileHeading" values={{ name: displayName }} /> : null}
        </h1>
        {editLinkMobile}
        {editLinkDesktop}
      </div>
    ...
    const mobileReviews = (
      <div className={css.mobileReviews}>
        <h2 className={css.mobileReviewsTitle}>
          <FormattedMessage id="ProfilePage.reviewsOfProviderTitle" values={{ count: reviewsOfProvider.length }} />
        </h2>
        {queryReviewsError ? reviewsError : null}
        <Reviews reviews={reviewsOfProvider} />
        <h2 className={css.mobileReviewsTitle}>
          <FormattedMessage id="ProfilePage.reviewsOfCustomerTitle" values={{ count: reviewsOfCustomer.length }} />
        </h2>
        {queryReviewsError ? reviewsError : null}
...
const mapStateToProps = (state) => {
  ...
  const { userId, userShowError, queryListingsError, userListingRefs, reviews, queryReviewsError } = state.ProfilePage
