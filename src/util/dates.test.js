...
describe('date utils', () => {
  ...
  describe('getTimeZoneNames()', () => {
    it('should return filtered time zone names', () => {
      ...
      expect(getTimeZoneNames(relevantZonesPattern)).toEqual(['Australia/Eucla', 'Europe/Helsinki'])
    })
  })

  describe('localizeAndFormatDate()', () => {
    it('should return localized date for "2019-09-18T00:45:00.000Z"', () => {
      expect(localizeAndFormatDate(intl, 'America/Los_Angeles', new Date('2019-09-18T00:45:00.000Z'))).toEqual(
        '9/17/2019, 05:45 PM'
      )
    })

    it('should return localized time for "2019-09-18T00:45:00.000Z"', () => {
      expect(localizeAndFormatTime(intl, 'America/Los_Angeles', new Date('2019-09-18T00:45:00.000Z'))).toEqual(
        '05:45 PM'
      )
    })
    it('should return localized time for "2019-09-18T00:45:00.000Z" with 12h format', () => {
      ...
      expect(
        localizeAndFormatTime(intl, 'America/Los_Angeles', new Date('2019-09-18T00:45:00.000Z'), formattingOptions)
      ).toEqual('5:45 PM')
    })
  })
  ...
  describe('getMonthStartInTimeZone() for 2019-11-23', () => {
    it('should return correct start of the month', () => {
      ...
      expect(localizeAndFormatDate(intl, 'Australia/Eucla', getMonthStartInTimeZone(date, 'Australia/Eucla'))).toEqual(
        '11/1/2019, 12:00 AM'
      )
      expect(localizeAndFormatDate(intl, 'Europe/Helsinki', getMonthStartInTimeZone(date, 'Europe/Helsinki'))).toEqual(
        '11/1/2019, 12:00 AM'
      )
      expect(
        localizeAndFormatDate(intl, 'America/Los_Angeles', getMonthStartInTimeZone(date, 'America/Los_Angeles'))
  ...
  describe('nextMonthFn() for 2019-11-23', () => {
    it('should return correct start of the next month', () => {
      // November == 10
      const date = new Date(Date.UTC(2019, 10, 23, 14, 34, 22))
      expect(localizeAndFormatDate(intl, 'Australia/Eucla', nextMonthFn(date, 'Australia/Eucla'))).toEqual(
        '12/1/2019, 12:00 AM'
      )
      expect(localizeAndFormatDate(intl, 'Europe/Helsinki', nextMonthFn(date, 'Europe/Helsinki'))).toEqual(
        '12/1/2019, 12:00 AM'
      )
      expect(localizeAndFormatDate(intl, 'America/Los_Angeles', nextMonthFn(date, 'America/Los_Angeles'))).toEqual(
        '12/1/2019, 12:00 AM'
      )
    })
  })
  ...
  describe('prevMonthFn() for 2019-11-23', () => {
    it('should return correct start of the next month', () => {
      // November == 10
      const date = new Date(Date.UTC(2019, 10, 23, 14, 34, 22))
      expect(localizeAndFormatDate(intl, 'Australia/Eucla', prevMonthFn(date, 'Australia/Eucla'))).toEqual(
        '10/1/2019, 12:00 AM'
      )
      expect(localizeAndFormatDate(intl, 'Europe/Helsinki', prevMonthFn(date, 'Europe/Helsinki'))).toEqual(
        '10/1/2019, 12:00 AM'
      )
      expect(localizeAndFormatDate(intl, 'America/Los_Angeles', prevMonthFn(date, 'America/Los_Angeles'))).toEqual(
        '10/1/2019, 12:00 AM'
      )
    })
  })
  ...
  describe('resetToStartOfDay()', () => {
    ...
    it('reset to start of day with given offset', () => {
      expect(resetToStartOfDay(date, 'Etc/UTC', 5)).toEqual(new Date(Date.UTC(2019, 10, 15, 0, 0, 0)))
    })
  })
