...
import { createUser, createCurrentUser, createListing, createOwnListing, fakeIntl } from '../../util/test-data'
...
describe('ListingPage', () => {
  ...
  describe('ActionBarMaybe', () => {
    ...
    it('shows closed listing status', () => {
      ...
      const actionBar = shallow(<ActionBarMaybe isOwnListing={false} listing={listing} editParams={{}} />)
      const formattedMessages = actionBar.find(FormattedMessage)
