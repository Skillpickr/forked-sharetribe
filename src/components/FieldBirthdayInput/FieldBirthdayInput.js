...
class BirthdayInputComponent extends Component {
  ...
  render() {
    const { selectClassName, dateId, monthId, yearId, dateLabel, monthLabel, yearLabel, disabled, intl } = this.props
...
const FieldBirthdayInputComponent = (props) => {
  const { rootClassName, className, id, label, labelForMonth, labelForYear, disabled, input, meta, valueFromForm } =
    props
