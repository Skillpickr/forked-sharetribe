...
export const PaginationLinksComponent = (props) => {
  const { className, rootClassName, intl, pageName, pagePathParams, pageSearchParams, pagination } = props
  ...
  const prevLinkDisabled = (
    <div className={css.prev}>
      <IconArrowHead direction="left" size="big" rootClassName={classNames(css.arrowIcon, css.disabled)} />
    </div>
  )
  ...
  const nextLinkDisabled = (
    <div className={css.next}>
      <IconArrowHead direction="right" size="big" rootClassName={classNames(css.arrowIcon, css.disabled)} />
    </div>
  )
