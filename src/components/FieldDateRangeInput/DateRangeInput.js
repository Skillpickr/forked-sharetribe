...
const PrevIcon = (props) => <IconArrowHead {...props} direction="left" rootClassName={css.arrowIcon} />
const NextIcon = (props) => <IconArrowHead {...props} direction="right" rootClassName={css.arrowIcon} />
...
class DateRangeInputComponent extends Component {
  ...
  render() {
    ...
    const startDatePlaceholderTxt =
      startDatePlaceholderText || intl.formatMessage({ id: 'FieldDateRangeInput.startDatePlaceholderText' })
    const endDatePlaceholderTxt =
      endDatePlaceholderText || intl.formatMessage({ id: 'FieldDateRangeInput.endDatePlaceholderText' })
    const screenReaderInputText =
      screenReaderInputMessage || intl.formatMessage({ id: 'FieldDateRangeInput.screenReaderInputMessage' })
