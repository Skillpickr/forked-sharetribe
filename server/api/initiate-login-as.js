...
const CONSOLE_URL = process.env.SERVER_SHARETRIBE_CONSOLE_URL || 'https://flex-console.sharetribe.com'
 ...
 */
const urlifyBase64 = (base64Str) => base64Str.replace(/\+/g, '-').replace(/\//g, '_').replace(/=/g, '')
