...
describe('SearchPage.helpers', () => {
  describe('validURLParamForExtendedData', () => {
    it('returns a valid parameter', () => {
      const validParam = validURLParamForExtendedData('pub_certificate', '200h', filters, sortConfig)
    ...
    it('drops an invalid param value', () => {
      const validParam = validURLParamForExtendedData('pub_certificate', 'invalid', filters, sortConfig)
      expect(validParam).toEqual({})
    })

    it('drops a param with invalid name', () => {
      const validParam = validURLParamForExtendedData('pub_invalid', 'vinyasa', filters, sortConfig)
      expect(validParam).toEqual({})
    })
  })
  ...
  describe('validFilterParams', () => {
    ...
    it('drops an invalid filter param value', () => {
      const params = { pub_certificate: '200h', pub_skills: 'invalid1,invalid2' }
