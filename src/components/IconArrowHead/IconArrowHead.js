...
const IconArrowHead = (props) => {
  ...
  if (isRight && isSmall) {
    return (
      <svg className={classes} width="9" height="13" viewBox="0 0 9 13" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    return (
      <svg className={classes} width="13" height="9" viewBox="0 0 13 9" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    return (
      <svg className={classes} width="11" height="15" viewBox="0 0 11 15" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    return (
      <svg className={classes} width="15" height="11" viewBox="0 0 15 11" xmlns="http://www.w3.org/2000/svg">
        <path
