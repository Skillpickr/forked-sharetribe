...
const SectionFeaturesMaybe = props => {
  ...
  const selectedSubOptions = publicData && publicData.photographerType ? publicData.photographerType : [];
  ...
  const selectedConfigSubOptions = subOptions.filter(o => selectedSubOptions.find(s => s === o.key));
    ...
    <div className={css.sectionFeatures}>
      ...
      <h2 className={css.featuresTitle}>
        <FormattedMessage
          ...
          values={{ skill: optionLabel.toLowerCase() }}
        />
      </h2>
      <PropertyGroup
