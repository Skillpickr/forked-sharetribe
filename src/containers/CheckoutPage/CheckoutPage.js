...
export class CheckoutPageComponent extends Component {
  ...
  loadInitialData() {
    ...
    const pageData = hasDataInProps ? { bookingData, bookingDates, listing, transaction } : storedData(STORAGE_KEY)
  ...
  handlePaymentIntent(handlePaymentParams) {
    ...
    const { pageData, speculatedTransaction, message, paymentIntent, selectedPaymentMethod, saveAfterOnetimePayment } =
      handlePaymentParams
  ...
  render() {
    ...
    const listingLink = (
      <NamedLink name="ListingPage" params={{ id: currentListing.id.uuid, slug: createSlug(listingTitle) }}>
        ...
        <div className={css.contentContainer}>
          ...
          <div className={css.bookListingContainer}>
            ...
            <section className={css.paymentContainer}>
              ...
              {retrievePaymentIntentError ? (
                <p className={css.orderError}>
                  <FormattedMessage id="CheckoutPage.retrievingStripePaymentIntentFailed" values={{ listingLink }} />
                </p>
              ) : null}
              {showPaymentForm ? (
                <StripePaymentForm
