...
export const defaultPredictions = (
  config.maps.search.suggestCurrentLocation ? [{ id: CURRENT_LOCATION_ID, predictionPlace: {} }] : []
    ...
    return (
      <div className={rootClass}>
        <div className={iconClass}>
          {this.state.fetchingPlaceDetails ? <IconSpinner className={css.iconSpinner} /> : <IconHourGlass />}
        </div>
        <input
