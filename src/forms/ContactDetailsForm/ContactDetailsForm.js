      ...
      <FinalForm
        ...
        render={(fieldRenderProps) => {
          ...
          if (emailVerified && !pendingEmail && !emailChanged) {
            ...
            emailVerifiedInfo = (
              <span className={css.emailUnverified}>
                <FormattedMessage id="ContactDetailsForm.emailUnverified" values={{ resendEmailMessage }} />
              </span>
            )
          ...
          const submitDisabled =
            invalid || pristineSinceLastSubmit || inProgress || !(emailChanged || phoneNumberChanged)
