...
describe('util/routes.js', () => {
  describe('createResourceLocatorString', () => {
    ...
    it('should return meaningful strings with path parameters', () => {
      expect(createResourceLocatorString('ListingPage', routes, { id: '1234', slug: 'nice-listing' }, {})).toEqual(
        '/l/nice-listing/1234'
      )
      expect(() => createResourceLocatorString('ListingPage', routes, {}, {})).toThrowError(
        TypeError('Expected "slug" to be a string')
      )
      expect(() => createResourceLocatorString('ListingPage', routes, { id: '1234' }, {})).toThrowError(
        TypeError('Expected "slug" to be a string')
      )
      expect(() => createResourceLocatorString('ListingPage', routes, { slug: 'nice-listing' }, {})).toThrowError(
        TypeError('Expected "id" to be a string')
      )
    })

    it('should return meaningful strings with search parameters', () => {
      expect(createResourceLocatorString('SearchPage', routes, {}, { page: 2 })).toEqual('/s?page=2')
      expect(createResourceLocatorString('SearchPage', routes, {}, { address: 'Helsinki', page: 2 })).toEqual(
        '/s?address=Helsinki&page=2'
      )
    })

    it('should return meaningful strings with path and search parameters', () => {
      expect(
        createResourceLocatorString('ListingPage', routes, { id: '1234', slug: 'nice-listing' }, { extrainfo: true })
  ...
  describe('findRouteByRouteName', () => {
    ...
    it('should throw exception for non-existing route (BlaaBlaaPage)', () => {
      expect(() => findRouteByRouteName('BlaaBlaaPage', routes)).toThrowError('Component "BlaaBlaaPage" was not found.')
    })
  })
  ...
  describe('canonicalRoutePath', () => {
    ...
    it('handles ListingPage', () => {
      ...
      expect(canonicalRoutePath(routes, location)).toEqual('/l/00000000-0000-0000-0000-000000000000')
    })
    it('handles ListingPage book', () => {
      ...
      expect(canonicalRoutePath(routes, location)).toEqual('/l/00000000-0000-0000-0000-000000000000?book=true')
    })
