  ...
  return (
    <li className={css.example}>
      <h3 className={css.withMargin}>
        <NamedLink name="StyleguideComponent" params={{ component: componentName }} className={css.link}>
          {componentName}
        </NamedLink>{' '}
        /{' '}
        <NamedLink
      ...
      <div className={exampleWrapperClassName}>
        {rawOnly ? (
          <p>
            ...
            <NamedLink name="StyleguideComponentExampleRaw" params={{ component: componentName, example: exampleName }}>
              raw mode
            </NamedLink>{' '}
            only.
          </p>
